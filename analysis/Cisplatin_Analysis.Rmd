...
```
```{r, include=FALSE}
write.table(sig_genes, quote=F, row.names=F, col.names = TRUE, file='/Users/dalvinikita/Documents/Drug Response Analysis/cisplatin_topGenes.txt', sep='\t')
```

# Plotting Gene expression VS Cisplatin response 
