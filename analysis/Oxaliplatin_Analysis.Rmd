...
• Oxaliplatin response AUC Values
...
#Define Oxaliplatin AUC values as factor of interest in design matrix for correlation analysis 
...
```{r, include=FALSE}
write.table(sig_genes, quote=F, row.names=F, col.names = TRUE, file='/Users/dalvinikita/Documents/Drug Response Analysis/oxaliplatin_topGenes.txt', sep='\t')
```

# Plotting Gene expression VS Oxaliplatin response 
